...
const colorPrimary1 = Color(0xFF193D62);
const colorSecondary = Color(0xFFE4EEF7);

const colorAlertBlue = Color(0XFF396ACC);
...
const textHeadingPrimary = Color(0XFF111827);
const menuHighLightColor = Color(0xFFEFF5FB);
const profileAvatarBackgroundColor = Color(0xFFFF7F37);
